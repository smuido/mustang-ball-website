    ...
    <div className="page">
      <div className="page-hero">
        <div className="card page-hero-card">
          ...
          <h1>Our History</h1>
          <p>
            <Editable as="span" multiline blockKey="ourHistory" path={['intro']} />
          </p>
        </div>
      ...
      <div className="timeline">
        {milestones.map((_, index) => (
          <div className="timeline-item mb-list-item" key={index}>
            ...
            <div>
              ...
              <p>
                <Editable as="span" multiline blockKey="ourHistory" path={['milestones', index, 'text']} />
              </p>
      ...
      <p>
        <Editable as="span" multiline blockKey="ourHistory" path={['press', 'intro']} />
      </p>
      <ul>
